...
class fwaas::enable_in_neutron_config {
  ...
  if (('controller' in hiera('roles')) or ('primary-controller' in hiera('roles'))) {
...
class fwaas {
  ...
  if $fwaas::params::ha and (('controller' in hiera('roles')) or ('primary-controller' in hiera('roles'))) {
